 ...
 * @author User0
 */
public class form_GestionInventario extends javax.swing.JFrame {

    /**
     * Creates new form form_SistemaEmpleadoPanel
     */
    public form_GestionInventario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_GestionInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_GestionInventario().setVisible(true);
            }
        });
    }
